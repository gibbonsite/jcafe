...
<div class="page">
    ...
    <div class="container justify-content-center col-12 col-sm-6 mt-3" >
        <fmt:message key="order.order_score_report_failed"/>
        <fmt:message key="order.return_to_order_score_report"/> 
        <a href="${absolutePath}/controller?command=go_to_order_score_report_page&id=${param.id}"><fmt:message key="order.score_report"/></a>.
    </div>
