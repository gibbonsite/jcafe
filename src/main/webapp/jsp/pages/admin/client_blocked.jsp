...
<div class="page">
    ...
    <div class="container justify-content-center col-12 col-sm-6 mt-3" >
        <fmt:message key="admin.client_blocked"/>
        <fmt:message key="admin.return_to_list_of_clients"/> <a href="${absolutePath}/controller?command=find_all_clients"><fmt:message key="user.list_clients"/></a>.
    </div>
