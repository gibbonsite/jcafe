...
<div class="page">
    ...
    <div class="container justify-content-center col-12 col-sm-6 mt-3" >
        <fmt:message key="menu.product_removed"/>
        <fmt:message key="menu.return_to_menu"/> <a href="${absolutePath}/controller?command=find_all_menu"><fmt:message key="header.menu"/></a>.
    </div>
