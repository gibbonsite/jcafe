...
<div class="page">
    ...
    <div class="container justify-content-center col-12 col-sm-6 mt-3" >
        <fmt:message key="section.section_removed"/>
        <fmt:message key="section.return_to_sections"/> <a href="${absolutePath}/jsp/pages/admin/section.jsp"><fmt:message key="section.return_to_sections_end"/></a>.
    </div>
