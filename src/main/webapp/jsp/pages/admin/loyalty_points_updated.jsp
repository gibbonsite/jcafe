...
<div class="page">
    ...
    <div class="container justify-content-center col-12 col-sm-6 mt-3" >
        <fmt:message key="order.loyalty_points_updated"/>
        <fmt:message key="order.return_to_cancelled_orders"/> <a href="${absolutePath}/controller?command=find_cancelled_orders"><fmt:message key="order.return_to_cancelled_orders_end"/></a>.
    </div>
