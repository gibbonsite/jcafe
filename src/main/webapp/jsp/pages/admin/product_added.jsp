...
<div class="page">
    ...
    <div class="container justify-content-center col-12 col-sm-6 mt-3" >
        <fmt:message key="menu.product_added"/>
        <fmt:message key="menu.add_more_products"/> <a href="${absolutePath}/jsp/pages/admin/add_product.jsp"><fmt:message key="menu.insert_menu"/></a>.
    </div>
