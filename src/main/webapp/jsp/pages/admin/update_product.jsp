...
<div class="page">
    ...
    <div class="container justify-content-center">
        ...
        <form name="AddProductFord" method="post" action="${absolutePath}/controller"  novalidate>
            ...
            <input type="hidden" name="id" value="${requestScope.menu.menuId}">
            <div class="form-group" class="mb-3">
                <label class="form-label"><fmt:message key="menu.product_name"/> </label>
                <input type="text" id="productName" name="product_name" value="${requestScope.menu.name}" class="form-control" required pattern="^[A-Za-zА-Яа-я\s]{3,50}$" />
            ...
            <div class="form-group" class="mb-3">
                ...
                <input type="text" id="productDescription" name="product_description"  value="${fn:escapeXml(requestScope.menu.description)}" class="form-control" pattern="^.{0,200}$" />
                <span class="error"></span>
            ...
            <div class="form-group" class="mb-3">
                ...
                <fmt:formatNumber type="number" minFractionDigits="0" maxFractionDigits="0"  value="${requestScope.menu.weight}" var="formattedWeight"/>
                <input type="text" id="productWeight" name="product_weight" value="${formattedWeight}" class="form-control" required pattern="\d{1,6}" />
                <span class="error"></span>
            ...
            <div class="form-group" class="mb-3">
                ...
                <input type="text" id="productLoyalScore" name="product_loyal_score" value="${requestScope.menu.loyalScore}" class="form-control" required pattern="\d{1,6}(\.[0-9]{1,2})?" />
                <span class="error"></span>
                <div id="discountHelp" class="form-text"><fmt:message key="menu.loyal_score_pattern"></fmt:message></div>
            ...
            <div class="form-group" class="mb-3">
                ...
                <input type="text" id="productPrice" name="product_price" value="${requestScope.menu.price}" class="form-control" required pattern="\d{1,6}(\.[0-9]{1,2})?" />
                <span class="error"></span>
            ...
            <select id="productSection" class="form-select" aria-label="Default select example" name="product_section" required>
                <option  disabled value=""><fmt:message key="menu.product_section"/></option>
                <c:forEach var="item" items="${applicationScope.section_list}">
                    <c:choose>
                    <c:when test="${ item.sectionId == requestScope.menu.sectionId}">
