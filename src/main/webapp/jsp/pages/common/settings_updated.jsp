...
<div class="page">
    ...
    <div class="container justify-content-center col-12 col-sm-6 mt-3" >
        <fmt:message key="settings.settings_changed"/>
        <fmt:message key="settings.return_to_settings"/> <a href="${absolutePath}/controller?command=go_to_settings"><fmt:message key="profile.settings"/></a>.
