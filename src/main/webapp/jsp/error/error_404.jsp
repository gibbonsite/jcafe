...
<c:set var="current_page" value="/jsp/error/error_404.jsp" scope="session"/>
<c:choose>
...
<div class="page">
    ...
    <div class="container justify-content-center col-12 col-sm-6 mt-3" >
        <fmt:message key="error.error_404"/> <a href="${absolutePath}/jsp/pages/home.jsp"><fmt:message key="error.home_page"/></a>
    </div>
